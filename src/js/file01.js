...
import { fetchProducts } from "/src/js/functions.js";
...
function renderProducts() {
    fetchProducts("https://data-dawm.github.io/datum/reseller/products.json").then(result => { /* bloque then */
        if (result.success == true) {
            ...
            products.forEach(product => {
                ...
                productHTML = productHTML.replaceAll("[PRODUCT.IMGURL]", product.imageUrl);
